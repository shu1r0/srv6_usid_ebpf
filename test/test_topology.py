...
def main():
    ...
    n6.cmd("../cmd/srv6_usid/main add fdbb:bbbb:0600::/48 -action uN -link n6_n5", verbose=True)
    ...
    n2.cmd("ip -6 route add fd00:a::2/128 encap seg6 mode encap segs fdbb:bbbb:0600:0100:f00d:: dev n2_h2", verbose=True)
